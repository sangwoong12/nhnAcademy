...
ALTER TABLE `resident`   MODIFY `resident_serial_number` bigint NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `household`   MODIFY `household_serial_number` bigint NOT NULL AUTO_INCREMENT;
