...
CREATE TABLE IF NOT EXISTS `mydb`.`profile` (
  ...
  INDEX `fk_profile_image1_idx` (`image_image_id` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`my_buddy` (
  ...
  INDEX `fk_my_buddy_image1_idx` (`image_id` ASC) ,
  CONSTRAINT `fk_pet_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `mydb`.`user` (`user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_my_buddy_image1`
...
CREATE TABLE IF NOT EXISTS `mydb`.`body_info` (
  ...
  CONSTRAINT `fk_body_size_my_buddy1`
    FOREIGN KEY (`my_buddy_id`)
    REFERENCES `mydb`.`my_buddy` (`buddy_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`disease_buddy` (
  `disease_code` INT NOT NULL,
  `buddy_id` INT NOT NULL,
  INDEX `fk_table1_disease1_idx` (`disease_code` ASC) ,
  INDEX `fk_table1_my_buddy1_idx` (`buddy_id` ASC) ,
  PRIMARY KEY (`disease_code`, `buddy_id`),
  CONSTRAINT `fk_table1_disease1`
    FOREIGN KEY (`disease_code`)
    REFERENCES `mydb`.`disease` (`disease_code`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_table1_my_buddy1`
...
CREATE TABLE IF NOT EXISTS `mydb`.`allergy_buddy` (
  ...
  INDEX `fk_allergy_has_my_buddy_my_buddy1_idx` (`my_buddy_buddy_id` ASC) ,
  INDEX `fk_allergy_has_my_buddy_allergy1_idx` (`allergy_allergy_code` ASC),
  CONSTRAINT `fk_allergy_has_my_buddy_allergy1`
    FOREIGN KEY (`allergy_allergy_code`)
    REFERENCES `mydb`.`allergy` (`allergy_code`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_allergy_has_my_buddy_my_buddy1`
    FOREIGN KEY (`my_buddy_buddy_id`)
    REFERENCES `mydb`.`my_buddy` (`buddy_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`event` (
  ...
  INDEX `fk_event_image1_idx` (`image_image_id` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`product` (
  ...
  INDEX `fk_product_event1_idx` (`event_id` ASC),
  CONSTRAINT `fk_product_sub_category1`
    FOREIGN KEY (`sub_category_id`)
    REFERENCES `mydb`.`sub_category` (`sub_category_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `mydb`.`and_you` (
  ...
  INDEX `fk_and_you_and_you_type1_idx` (`and_you_type_type_code` ASC) ,
  PRIMARY KEY (`and_you_id`),
  CONSTRAINT `fk_and_you_and_you_type1`
    FOREIGN KEY (`and_you_type_type_code`)
    REFERENCES `mydb`.`and_you_type` (`type_code`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`option` (
  ...
  INDEX `fk_option_product1_idx` (`product_product_id` ASC) ,
  CONSTRAINT `fk_option_product1`
...
CREATE TABLE IF NOT EXISTS `mydb`.`option_value` (
  ...
  INDEX `fk_option_value_option1_idx` (`option_id` ASC) ,
  CONSTRAINT `fk_option_value_option1`
...
CREATE TABLE IF NOT EXISTS `mydb`.`and_you_has_image` (
  ...
  INDEX `fk_and_you_has_image_image1_idx` (`image_image_id` ASC) ,
  INDEX `fk_and_you_has_image_and_you1_idx` (`and_you_and_you_id` ASC),
  CONSTRAINT `fk_and_you_has_image_and_you1`
    FOREIGN KEY (`and_you_and_you_id`)
    REFERENCES `mydb`.`and_you` (`and_you_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_and_you_has_image_image1`
    FOREIGN KEY (`image_image_id`)
    REFERENCES `mydb`.`image` (`image_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `mydb`.`wishlist` (
  ...
  INDEX `fk_user_has_product_user1_idx` (`user_user_id` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`cart` (
  ...
  INDEX `fk_cart_product1_idx` (`product_product_id` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`order_detail` (
  ...
  INDEX `fk_order_history_product1_idx` (`product_id` ASC),
  INDEX `fk_order_history_order1_idx` (`order_id` ASC),
  CONSTRAINT `fk_order_history_product1`
    FOREIGN KEY (`product_id`)
    REFERENCES `mydb`.`product` (`product_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `mydb`.`deliver_address` (
  ...
  `address` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`user_id`),
  CONSTRAINT `fk_deliver_address_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `mydb`.`user` (`user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `mydb`.`user_has_coupon` (
  ...
  INDEX `fk_user_has_coupon_coupon1_idx` (`coupon_coupon_id` ASC),
  INDEX `fk_user_has_coupon_user1_idx` (`user_user_id` ASC),
  ...
  CONSTRAINT `fk_user_has_coupon_coupon1`
    ...
    REFERENCES `mydb`.`coupon` (`coupon_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`inquiry` (
  ...
  INDEX `fk_inquiry_inquiry1_idx` (`parent_inquiry_id` ASC),
  INDEX `fk_inquiry_product1_idx` (`product_product_id` ASC),
  INDEX `fk_inquiry_user1_idx` (`user_user_id` ASC) VISIBLE,
  CONSTRAINT `fk_inquiry_inquiry1`
    FOREIGN KEY (`parent_inquiry_id`)
    REFERENCES `mydb`.`inquiry` (`inquiry_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `mydb`.`product_has_image` (
  ...
  INDEX `fk_product_has_image_image1_idx` (`image_image_id` ASC),
  INDEX `fk_product_has_image_product1_idx` (`product_product_id` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`comment_has_image` (
  ...
  INDEX `fk_comment_has_image_image1_idx` (`image_image_id` ASC) ,
  INDEX `fk_comment_has_image_comment1_idx` (`comment_comment_id` ASC) VISIBLE,
  CONSTRAINT `fk_comment_has_image_comment1`
    FOREIGN KEY (`comment_comment_id`)
    REFERENCES `mydb`.`comment` (`comment_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_comment_has_image_image1`
    FOREIGN KEY (`image_image_id`)
    REFERENCES `mydb`.`image` (`image_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `mydb`.`faq` (
  ...
  `faq_type_id` INT NOT NULL,
  PRIMARY KEY (`faq_id`),
  INDEX `fk_faq_faq_type1_idx` (`faq_type_id` ASC) ,
  CONSTRAINT `fk_faq_faq_type1`
    FOREIGN KEY (`faq_type_id`)
    REFERENCES `mydb`.`faq_type` (`faq_type_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
