...
import org.example.pattern.singleton.example.print.PrintSavingAccount;

public class SavingBankAccount implements IAccount {
    ...
    public SavingBankAccount(String ownerName, BigDecimal balance) {
        this.accountNumber = CreateAccount.getCreateAccount().createAccountNumber(this);
        this.ownerName = ownerName;
        this.balance = balance;
        this.iPrint = new PrintSavingAccount();
    }
