...
class StudentsTest {
    ...
    @BeforeEach
    public void setUp() {
        ReflectionTestUtils.setField(students, "path", Objects.requireNonNull(CsvStudents.class.getResource("/")).getPath());
        ReflectionTestUtils.setField(students, "studentList", new ArrayList<>());
    }
